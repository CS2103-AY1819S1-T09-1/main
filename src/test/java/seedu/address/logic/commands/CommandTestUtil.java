...
public class CommandTestUtil {
        ...
        public static final String VALID_START_DATETIME_DESC = " " + VALID_START_DATE_DESC + " "
        ...
        static {
                FIND_BRUSH_BY_NAME = new FindTaskPredicateAssemblerBuilder().withNamePredicate(BRUSH_NAME_PREDICATE)
                                .build();
                FIND_BRUSH_BY_END_DATE = new FindTaskPredicateAssemblerBuilder()
                                .withEndDatePredicate(BRUSH_END_DATE_PREDICATE).build();
                ...
                FIND_SLAUGHTER_BY_NAME_AND_START_DATE = new FindTaskPredicateAssemblerBuilder()
                                ...
                                .withStartDatePredicate(SLAUGHTER_START_DATE_PREDICATE).build();
                FIND_SLAUGHTER_BY_TAG = new FindTaskPredicateAssemblerBuilder()
                                .withTagsPredicate(SLAUGHTER_TAG_PREDICATE).build();
        }
        ...
        public static final String START_DATETIME_DESC_SLAUGHTER = START_DATE_DESC_SLAUGHTER
                        + START_TIME_DESC_SLAUGHTER;
        ...
        public static void showTaskAtIndex(Model model, Index targetIndex) {
                ...
                model.updateFilteredTaskList(new seedu.address.model.task.NameContainsKeywordsPredicate(
