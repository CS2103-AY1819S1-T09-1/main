...
[NOTE]
You can add multiple people or multiple tasks with the same name because internally we track them with
a unique id.
...
* When editing tags, the existing tags of the person will be removed i.e adding of tags is not cumulative.
* You can specify `t/` to indicate that you want to clear all existing tags.
* Date and time are regarded as one field, and after editing, start DateTime
must be before end DateTime.
****

Examples:

* `tasks edit 1 sd/20050108 st/1235` +
Edits the start DateTime of the 1st task to be 8 January 2005, 12.35pm.
